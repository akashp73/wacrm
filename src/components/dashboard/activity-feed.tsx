...
const KIND_THEME: Record<ActivityKind, KindTheme> = {
  ...
  contact: { icon: UserPlus, badge: 'bg-foreground/10 text-foreground' },
  deal: { icon: Briefcase, badge: 'bg-foreground/10 text-foreground' },
  ...
  return (
    <section className="rounded-xl border border-border bg-card">
      <header className="flex items-center justify-between border-b border-border px-5 py-4">
        ...
        <Link
          href="/inbox"
          className="text-xs font-medium text-foreground hover:text-violet-300"
        >
          View all →
        </Link>
      </header>
