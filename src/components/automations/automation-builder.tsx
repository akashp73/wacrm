          ...
          <div className="space-y-3 border-t border-border px-4 py-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-border bg-muted px-2 py-1.5 text-sm text-foreground focus:border-foreground focus:outline-none"
              >
      ...
      <div className={cn("z-10 flex flex-col", width)}>
        ...
        >
          ...
          >
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-md bg-muted text-foreground/70">
...
function ConditionBranches({
  ...
  return (
    ...
    <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
      <BranchColumn label="Yes" color="text-foreground">
