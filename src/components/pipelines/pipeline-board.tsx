  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-border bg-card/60 p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      ...
      <div className="flex items-center justify-between pt-3">
        ...
        <span className="shrink-0 rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium text-foreground/70">
          {deals.length}
        </span>
      </div>
      ...
      <div
        ...
        className={`mt-3 flex flex-1 flex-col gap-2 rounded-lg transition-all ${
          isOver
            ? "bg-foreground/5 outline outline-2 outline-dashed outline-violet-400 outline-offset-2"
            : ""
        }`}
      >
        {deals.length === 0 ? (
      ...
      <Button
        ...
        className="mt-3 w-full justify-start border border-dashed border-border bg-transparent text-muted-foreground hover:border-foreground/40 hover:bg-muted hover:text-foreground"
      >
