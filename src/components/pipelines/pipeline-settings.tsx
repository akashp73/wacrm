          ...
          <div className="py-4">
            ...
            <div className="mt-4 flex justify-end gap-2">
              <Button
                ...
                className="border-border bg-transparent text-foreground/70 hover:bg-muted"
              >
                Cancel
              </Button>
              <Button
          ...
          <>
            <div className="grid gap-4 py-2">
              <div className="grid gap-2">
                <Label className="text-foreground/70">Pipeline Name</Label>
                <Input
                  value={name}
              ...
              <div className="grid gap-2">
                <Label className="text-foreground/70">Stages</Label>
                <DndContext
                  sensors={sensors}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="shrink-0 border-border bg-transparent text-foreground/70 hover:bg-muted"
                  >
              ...
              <Button
                ...
                className="w-full border-border bg-transparent text-foreground/70 hover:bg-muted"
              >
                <Plus className="mr-1 h-3 w-3" />
  ...
  return (
    ...
    >
      <button
        ...
        {...attributes}
        {...listeners}
        className="cursor-grab touch-none text-muted-foreground hover:text-foreground/70 active:cursor-grabbing"
