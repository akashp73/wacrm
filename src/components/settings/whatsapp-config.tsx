...
export function WhatsAppConfig() {
  ...
  useEffect(() => {
    ...
    if (ownerId) fetchConfig(ownerId);
  }, [authLoading, user, ownerId, fetchConfig]);
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (ownerId) await fetchConfig(ownerId);
    } catch (err) {
    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_380px] mt-4">
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label className="text-foreground/70">Phone Number ID</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-foreground/70">WhatsApp Business Account ID</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-foreground/70">Permanent Access Token</Label>
            ...
            <div className="space-y-2">
              <Label className="text-foreground/70">Webhook Verify Token</Label>
              <Input
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent>
            <div className="space-y-2">
              <Label className="text-foreground/70">Webhook Callback URL</Label>
              <div className="flex gap-2">
                <Input
                  readOnly
                  value={webhookUrl}
                  className="bg-muted border-border text-foreground/70 font-mono text-sm"
                />
                <Button
                  variant="outline"
                  size="icon"
                  onClick={handleCopyWebhookUrl}
                  className="shrink-0 border-border text-foreground/70 hover:text-foreground hover:bg-muted"
                >
          ...
          <CardContent>
            <Accordion>
              <AccordionItem className="border-border">
                <AccordionTrigger className="text-foreground/70 hover:text-foreground hover:no-underline">
                  <span className="flex items-center gap-2">
                    <span className="flex size-5 items-center justify-center rounded-full bg-foreground text-xs font-bold text-background">1</span>
                    Create a Meta App
                  </span>
                </AccordionTrigger>
              ...
              <AccordionItem className="border-border">
                <AccordionTrigger className="text-foreground/70 hover:text-foreground hover:no-underline">
                  <span className="flex items-center gap-2">
                    <span className="flex size-5 items-center justify-center rounded-full bg-foreground text-xs font-bold text-background">2</span>
              ...
              <AccordionItem className="border-border">
                <AccordionTrigger className="text-foreground/70 hover:text-foreground hover:no-underline">
                  <span className="flex items-center gap-2">
                    <span className="flex size-5 items-center justify-center rounded-full bg-foreground text-xs font-bold text-background">3</span>
                    Get API Credentials
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
              ...
              <AccordionItem className="border-border">
                <AccordionTrigger className="text-foreground/70 hover:text-foreground hover:no-underline">
                  <span className="flex items-center gap-2">
                    <span className="flex size-5 items-center justify-center rounded-full bg-foreground text-xs font-bold text-background">4</span>
                    Configure Webhooks
                  </span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <a
                ...
                className="inline-flex items-center gap-1.5 text-sm text-foreground hover:text-violet-300 transition-colors"
              >
